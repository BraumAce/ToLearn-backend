...
import com.toLearn.Service.FriendsService;
...
public class FriendsController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "friendAddRequest", value = "好友添加请求"),
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "fromId", value = "申请id"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "申请id"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "ids", value = "申请id"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
