...
import com.toLearn.Model.Request.UpdatePasswordRequest;
import com.toLearn.Model.Request.UserLoginRequest;
...
import com.toLearn.Utils.MessageUtils;
import com.toLearn.Utils.ValidateCodeUtils;
...
public class UserController {
    ...
    public BaseResponse<String> sendMailUpdateMessage(String email,
        ...
        mimeMessageHelper.setText("我们收到了一项请求，要求更新您的邮箱地址为"
                + email + "。本次操作的验证码为："
                + code + "。如果您并未请求此验证码，则可能是他人正在尝试修改以下 ToLearn 帐号："
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "userLoginRequest", value = "用户登录请求参数"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updatePasswordRequest", value = "修改密码请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "user", value = "用户更新请求参数"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "tags", value = "标签"),
                        @ApiImplicitParam(name = "request", value = "request请求")})
